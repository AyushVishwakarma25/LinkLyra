 ...
 * 
 * Usage:
 *   npx tsx scripts/grant-plan.ts <email> <free|pro|business|agency>
 *   or:
...
if (args.length < 2) {
  console.log('\nUsage: npx tsx scripts/grant-plan.ts <email> <free|pro|business|agency>');
  console.log('Example: npx tsx scripts/grant-plan.ts user@example.com agency\n');
  process.exit(1);
}
