...
import { X, Lock, Mail, User as UserIcon, LogIn, UserPlus, LogOut, CheckCircle, AlertCircle, Cloud, Sparkles } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === 'signup') {
        ...
        setSuccessMsg('Account created successfully in Google Cloud!');
        onAuthSuccess(user);
        setTimeout(() => {
          onClose();
        }, 1000);
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 text-[11px] text-[#737882]">
                <Cloud className="w-3 h-3 text-[#5E4BF7]" />
          ...
          {currentUser ? (
            ...
            <div className="space-y-4 text-center py-4">
              ...
              <div className="p-3.5 bg-white rounded-2xl border border-black/5 text-left text-xs space-y-1.5">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#737882]">Cloud Storage:</span>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 bg-white hover:bg-black/5 border border-black/10 rounded-2xl font-bold text-xs text-[#1C1E22] flex items-center justify-center gap-2.5 shadow-2xs transition-all active:scale-95"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <>
                    <div>
                      ...
                      <div className="relative">
                        <UserIcon className="w-4 h-4 text-[#737882] absolute left-3.5 top-1/2 -translate-y-1/2" />
                        <input
                          type="text"
                          required
                ...
                <div>
                  ...
                  <div className="relative">
                    <Mail className="w-4 h-4 text-[#737882] absolute left-3.5 top-1/2 -translate-y-1/2" />
                    <input
                      type="email"
                      required
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="w-4 h-4 text-[#737882] absolute left-3.5 top-1/2 -translate-y-1/2" />
                    <input
                      type="password"
                      required
                      placeholder="••••••••"
